...
public class TicketMachine {
	...
	private final int price;  // The amount of money entered by a customer so far.
	private int balance;
	 ...
	 */
	public int refund() {
		int result; // Déclarer une variable pour le résulat
		// Initialiser le rÈsultat
		result = balance;
		if (balance > 0) {
	...
	public boolean printTicket() {
		// Il faut que la balance soit au moins egale au prix du ticket
		if (balance >= price) {
			...
			return true;
		} else { // On ne peut pas delivrer le ticket
